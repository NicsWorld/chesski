...
describe('App Main Functionality', () => {
  ...
  beforeEach(() => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    window.location = new URL("http://localhost/?fen=rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1") as any;
  });
...
describe('App invalid FEN fallback', () => {
  ...
  beforeEach(() => {
    ...
    delete window.location;
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    window.location = new URL("http://localhost/?fen=invalid_fen_string") as any;
  });
